...
Uma análise, quanto ao género, do perfil dos consumidores. Podemos constatar que existe uma pequena maioria de consumidores do género masculino, no entanto, apenas por uma margém ténue.
...
plot(as.factor(customers$MaritalStatus),
     ...
     las = 1)
```
Uma análise, quanto ao estado civil, do perfil dos consumidores, pode constatar-se que existe uma maioria de consumidores casados, face aos solteiros. 
